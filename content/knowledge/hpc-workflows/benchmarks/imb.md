---
title: IMB Benchmark Example
description: The Intel MPI Benchmark provides a tool for testing the parallel execution speed of one to many systems.
weight: 2
---
...
To use 64 CPU cores on a [SLURM HPC environment]({{< relref "knowledge/hpc-environment-basics/slurm/_index.md" >}}) for a single application, the instruction `--ntasks=64` can be used.
