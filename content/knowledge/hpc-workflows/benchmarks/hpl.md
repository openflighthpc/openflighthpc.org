...
The below example script is for 16 core, 64GB node with no IB Interconnect. The script is designed to be run with [SLURM]({{< relref "knowledge/hpc-environment-basics/slurm/_index.md" >}}).
