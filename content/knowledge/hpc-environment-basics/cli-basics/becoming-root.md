---
title: Becoming the Root User
description: How to gain superuser privileges
weight: 4
---
...
You can log out of the root user by running the command `exit`, `logout`, or by pressing <kbd>CTRL+D</kbd>
