---
title: Using Graphical Client
description: An example of using graphical tools to copy data
weight: 2
---
...
![](/images/knowledge/hpc-environment-basics/winscpconfig.png)
...
![](/images/knowledge/hpc-environment-basics/winscpcopyfiles.png)
