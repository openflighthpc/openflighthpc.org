---
title: Requesting More Resources
weight: 6
---
...
- Request 16 cores across 2 compute nodes
    ```
    --nodes=2 --ntasks=16
    ```
- Request all available cores of 2 compute nodes
    ```
    --nodes=2
    ```
- Request 16 cores across any available compute nodes
    ```
    --ntasks=16
    ```
