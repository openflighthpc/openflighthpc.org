---
title: Dynamic Scheduler Variables
description: A few commonly used scheduler variables for job outputs
weight: 5
---
...
[^1]: These relate to task array jobs, which are covered in a [previous section]({{< relref "knowledge/hpc-environment-basics/slurm/running-jobs/array" >}}).
