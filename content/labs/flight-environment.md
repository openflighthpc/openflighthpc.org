...
description: A collection of tools for HPC environment accessibility and management
date: 2019-08-01
params:
  status: maintenance
  source: https://github.com/openflighthpc/
toc: true
---
...
The Flight User Suite sits unobtrusively on the research environment by default, the tools will not be accessible until the [environment is activated]({{< relref "knowledge/flight-environment/basics.md" >}}).
